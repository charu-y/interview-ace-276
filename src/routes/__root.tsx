  ...
  head: () => ({
    meta: [
      ...
      { title: "InterviewPilot — AI Mock Interview Practice" },
      {
        name: "description",
        content:
          "Practice role-specific mock interviews with timed questions and an instant scored report card.",
      },
      { name: "author", content: "InterviewPilot" },
      { property: "og:title", content: "InterviewPilot — AI Mock Interview Practice" },
      {
        property: "og:description",
        content: "Timed mock interviews for SDE Intern, Data Analyst and Frontend roles.",
      },
